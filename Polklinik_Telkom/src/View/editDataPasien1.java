 ...
 * @author Dhino
 */
public class editDataPasien1 extends javax.swing.JFrame {

    /**
     * Creates new form editDataPasien1
     */
    public editDataPasien1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editDataPasien1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editDataPasien1().setVisible(true);
            }
        });
    }
