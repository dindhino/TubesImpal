 ...
 * @author Dhino
 */
public class deleteDataPasien extends javax.swing.JFrame {

    /**
     * Creates new form deleteDataPasien
     */
    public deleteDataPasien() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteDataPasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteDataPasien().setVisible(true);
            }
        });
    }
