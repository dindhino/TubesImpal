 ...
 * @author Dhino
 */
public class formInputDiagnosa2 extends javax.swing.JFrame {

    /**
     * Creates new form formInputDiagnosa2
     */
    public formInputDiagnosa2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formInputDiagnosa2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formInputDiagnosa2().setVisible(true);
            }
        });
    }
