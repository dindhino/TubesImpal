 ...
 * @author Dhino
 */
public class halamanMilihShiftJadwal1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(halamanMilihShiftJadwal1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new halamanMilihShiftJadwal1().setVisible(true);
            }
        });
    }
